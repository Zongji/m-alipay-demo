...
public class AlipayConfig {
    ...
    public static String notify_url = "https://e249-163-125-202-196.jp.ngrok.io/pay/pay-notify";
    // 页面跳转同步通知页面路径 需http://或者https://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问 商户可以自定义同步跳转地址
//    public static String return_url = "http://192.168.10.8:8080/pay-result"; //前台页面地址
    public static String return_url = "http://192.168.10.8:9090/pay/pay-return"; //后台页面地址
